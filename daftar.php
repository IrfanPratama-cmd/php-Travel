...
<body>
    ...
    <section id="boxes" class="order">
            <h1 align="center">Input Travel</h1>
			<form class="order"  action="cetak.php" method="post" enctype="multipart/form-data">
				<div>
				    <label class="label">Nama Travel</label><br>
					<input type="text" placeholder="Nama Travel" name="nama_travel" required>
				</div><br>
				<div>
					<label class="label">No. Travel</label><br>
					<input type="text" placeholder="No. Travel" name="no_travel" required>
				</div><br>
				<div>
                ...
                <div>
					...
					<input type="text" name="harga_travel" required>
                </div><br>
                <div>
					<label class="label">Input Gambar Travel</label><br>
