...
<body>
    ...
    <section id="boxes" class="order">
            <h1 align="center">Hapus Travel</h1>
			<form class="order"  action="cetakhapus.php" method="post">
				<div>
				    <label class="label">Nama Travel</label><br>
					<input type="text" placeholder="Nama Travel" name="nama_travel" value="<?= $row['nama_travel']?>" readonly>
				</div><br>
				<div>
					<label class="label">No. Travel</label><br>
					<input type="text" placeholder="No. Travel" name="no_travel" value="<?= $row['no_travel']?>" readonly>
				</div><br>
				<div>
					<label class="label">Kapasitas</label><br>
					<input type="text" name="kapasitas" value="<?= $row['kapasitas']?>" readonly>
                </div><br>
                <div>
					<label class="label">Harga Travel</label><br>
					<input type="text" name="harga_travel" value="<?= $row['harga_travel']?>" readonly>
                </div><br>
