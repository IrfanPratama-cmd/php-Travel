...
$harga_travel;
$deskripsi;
$queryinput = "UPDATE `daftar_travel` 
SET `nama_travel` = '$nama_travel', `kapasitas` = '$kapasitas', `harga_travel` = '$harga_travel', `deskripsi` = '$deskripsi' WHERE `no_travel` = '$no_travel'";
...
<body>
    ...
    <section id="boxes" class="order" align="center">
            ...
            <p><?= $nama_travel ?></p>
            <a href="hasil.php" class="aww">Lihat Database</a>
            <br><br>
        </section>
