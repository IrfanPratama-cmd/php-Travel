...
<body>
    ...
    <section id="newsletter">
		<div class="container">
            <div class="database">
                ...
                <li><a href="#">Input Destinasi</a></li>
            </div>
		</div>
    </section>
    ...
    <div id="wrapper">
        ...
        <section id="boxes" class="order">
            <h1 align="center">Input Destinasi</h1>
			<form class="order" action="cetak2.php" method="post" enctype="multipart/form-data">
				<div>
				    <label class="label">Nama Destinasi</label><br>
					<input type="text" placeholder="Nama Destinasi" name="destinasi" required>
				</div><br>
				<div>
					<label class="label">No. Destinasi</label><br>
					<input type="text" placeholder="No. Destinasi" name="no_destinasi" required>
				</div><br>
				<div>
					<label class="label">Harga Destinasi</label><br>
					<input type="text" name="harga_destinasi" required>
                </div><br>
                <div>
					<label class="label">Input Gambar Destinasi</label><br>
					<input type="file" name="gambar" required>
                </div><br>
                <div>
					<label class="label">Deskripsi</label><br>
					<textarea name="deskripsi" id="" cols="85" rows="4" required>Deskripsi</textarea>
                </div><br>
                <button class="button_1" type="gass">Send</button>
            </form>
        </section>
    <br>
    <footer>
