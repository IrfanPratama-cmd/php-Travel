...
<body>
    ...
    <section id="boxes" class="order">
            <h1 align="center">Edit Destinasi</h1>
			<form class="order" action="cetakedit2.php" method="post">
				<div>
				    <label class="label">Nama Destinasi</label><br>
					<input type="text" placeholder="Nama Destinasi" name="destinasi" value="<?= $row['destinasi']?>" required>
				</div><br>
				<div>
					<label class="label">No. Destinasi</label><br>
					<input type="number" placeholder="No. Destinasi" name="no_destinasi" value="<?= $row['no_destinasi']?>" required>
				</div><br>
				<div>
					<label class="label">Harga Destinasi</label><br>
					<input type="number" name="harga_destinasi" value="<?= $row['harga_destinasi']?>" required>
                </div><br>
                <div>
					<label class="label">Deskripsi</label><br>
					<textarea name="deskripsi" id="" cols="85" rows="4"  required><?= $row['deskripsi']?></textarea>
                </div><br>
                <button class="button_1" type="gass">Edit</button>
            </form>
        </section>
    <br>
    <footer>
