<?php 
        ...
        $queryselect = "SELECT * FROM orders WHERE telp='$target'";
...
<body>
    ...
    <section id="boxes" class="order">
            <h1 align="center">Hapus Order</h1>
			<form class="order" action="cetakhapusorder.php" method="post">
				<div>
				    <label class="label">Nama</label><br>
					<input type="text" placeholder="Nama " name="nama" value="<?= $row['nama']?>" readonly>
				</div><br>
				<div>
				...
				<div>
					...
					<input type="text" name="telp" value="<?= $row['telp']?>" readonly>
                </div><br>
                <div>
					<label class="label">Travel</label><br>
					<input type="text" name="travel" value="<?= $row['travel']?>" readonly>
                </div><br>
                <div>
					<label class="label">Destinasi</label><br>
					<input type="text" name="destinasi" value="<?= $row['destinasi']?>" readonly>
                </div><br>
